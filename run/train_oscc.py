...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default="/mnt/hdd1/ego4d_proj/mingxiaohuo_ego4d/EgoVLP/configs/ft/oscc.json", type=str,
                      help='config file path (default: None)')
                     # /rscratch/cfxu/mingxiaohuo_ego4d/EgoVLP/configs/ft/oscc.json
