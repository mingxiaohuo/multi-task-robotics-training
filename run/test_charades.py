...
sys.path.append('/rscratch/cfxu/mingxiaohuo_ego4d/EgoVLP/')

import torch
from model.model import sim_matrix
import model.metric as module_metric
import data_loader.data_loader_fun as module_data
...
def run():
    ...
    cls_arr = []
    with open('/rscratch/cfxu/tianran_ego4d/EgoVLP/CharadesEgo/Charades_v1_classes.txt', 'r') as charades:
...
if __name__ == '__main__':
    ...
    args.add_argument('-r', '--resume',
                      default = '/rscratch/cfxu/tianran_ego4d/EgoVLP/egovlp_epo1.pth',
