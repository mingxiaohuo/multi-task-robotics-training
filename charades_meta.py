...
metadata_dir = '/rscratch/cfxu/tianran_ego4d/EgoVLP/CharadesEgo/'
split_files = {
...
path_metadata = "/rscratch/cfxu/tianran_ego4d/EgoVLP/CharadesEgo/metadata_" + split + ".csv"
...
mapping = pd.read_csv('/rscratch/cfxu/tianran_ego4d/EgoVLP/CharadesEgo/Charades_v1_classes.txt', header=None)
